...
// We do not run `consensus-spec-tests/tests/*/gloas/ssz_static/Eth1Block/*/*`.
...
tests_for_type! {
    AggregateAndProof<_>,
    "consensus-spec-tests/tests/mainnet/gloas/ssz_static/AggregateAndProof/*/*",
    "consensus-spec-tests/tests/minimal/gloas/ssz_static/AggregateAndProof/*/*",
}

tests_for_type! {
    Attestation<_>,
    "consensus-spec-tests/tests/mainnet/gloas/ssz_static/Attestation/*/*",
    "consensus-spec-tests/tests/minimal/gloas/ssz_static/Attestation/*/*",
}

tests_for_type! {
    AttestationData,
    "consensus-spec-tests/tests/mainnet/gloas/ssz_static/AttestationData/*/*",
    "consensus-spec-tests/tests/minimal/gloas/ssz_static/AttestationData/*/*",
}

tests_for_type! {
    AttesterSlashing<_>,
    "consensus-spec-tests/tests/mainnet/gloas/ssz_static/AttesterSlashing/*/*",
    "consensus-spec-tests/tests/minimal/gloas/ssz_static/AttesterSlashing/*/*",
}

tests_for_type! {
    BeaconBlock<_>,
    "consensus-spec-tests/tests/mainnet/gloas/ssz_static/BeaconBlock/*/*",
    "consensus-spec-tests/tests/minimal/gloas/ssz_static/BeaconBlock/*/*",
}

tests_for_type! {
    BeaconBlockBody<_>,
    "consensus-spec-tests/tests/mainnet/gloas/ssz_static/BeaconBlockBody/*/*",
    "consensus-spec-tests/tests/minimal/gloas/ssz_static/BeaconBlockBody/*/*",
}

tests_for_type! {
    BeaconBlockHeader,
    "consensus-spec-tests/tests/mainnet/gloas/ssz_static/BeaconBlockHeader/*/*",
    "consensus-spec-tests/tests/minimal/gloas/ssz_static/BeaconBlockHeader/*/*",
}
...
tests_for_type! {
    ...
    "consensus-spec-tests/tests/mainnet/gloas/ssz_static/BLSToExecutionChange/*/*",
    "consensus-spec-tests/tests/minimal/gloas/ssz_static/BLSToExecutionChange/*/*",
}
...
tests_for_type! {
    ...
    "consensus-spec-tests/tests/mainnet/gloas/ssz_static/ConsolidationRequest/*/*",
    "consensus-spec-tests/tests/minimal/gloas/ssz_static/ConsolidationRequest/*/*",
}

tests_for_type! {
    ContributionAndProof<_>,
    "consensus-spec-tests/tests/mainnet/gloas/ssz_static/ContributionAndProof/*/*",
    "consensus-spec-tests/tests/minimal/gloas/ssz_static/ContributionAndProof/*/*",
}
...
tests_for_type! {
    Deposit,
    "consensus-spec-tests/tests/mainnet/gloas/ssz_static/Deposit/*/*",
    "consensus-spec-tests/tests/minimal/gloas/ssz_static/Deposit/*/*",
}

tests_for_type! {
    DepositData,
    "consensus-spec-tests/tests/mainnet/gloas/ssz_static/DepositData/*/*",
    "consensus-spec-tests/tests/minimal/gloas/ssz_static/DepositData/*/*",
}

tests_for_type! {
    DepositMessage,
    "consensus-spec-tests/tests/mainnet/gloas/ssz_static/DepositMessage/*/*",
    "consensus-spec-tests/tests/minimal/gloas/ssz_static/DepositMessage/*/*",
}

tests_for_type! {
    DepositRequest,
    "consensus-spec-tests/tests/mainnet/gloas/ssz_static/DepositRequest/*/*",
    "consensus-spec-tests/tests/minimal/gloas/ssz_static/DepositRequest/*/*",
}

tests_for_type! {
    Eth1Data,
    "consensus-spec-tests/tests/mainnet/gloas/ssz_static/Eth1Data/*/*",
    "consensus-spec-tests/tests/minimal/gloas/ssz_static/Eth1Data/*/*",
}

tests_for_type! {
    ExecutionPayload<_>,
    "consensus-spec-tests/tests/mainnet/gloas/ssz_static/ExecutionPayload/*/*",
    "consensus-spec-tests/tests/minimal/gloas/ssz_static/ExecutionPayload/*/*",
}
...
tests_for_type! {
    HistoricalSummary,
    "consensus-spec-tests/tests/mainnet/gloas/ssz_static/HistoricalSummary/*/*",
    "consensus-spec-tests/tests/minimal/gloas/ssz_static/HistoricalSummary/*/*",
}
...
tests_for_type! {
    ...
    "consensus-spec-tests/tests/mainnet/gloas/ssz_static/LightClientBootstrap/*/*",
    "consensus-spec-tests/tests/minimal/gloas/ssz_static/LightClientBootstrap/*/*",
}

tests_for_type! {
    LightClientFinalityUpdate<_>,
    "consensus-spec-tests/tests/mainnet/gloas/ssz_static/LightClientFinalityUpdate/*/*",
    "consensus-spec-tests/tests/minimal/gloas/ssz_static/LightClientFinalityUpdate/*/*",
}
...
tests_for_type! {
    ...
    "consensus-spec-tests/tests/mainnet/gloas/ssz_static/LightClientOptimisticUpdate/*/*",
    "consensus-spec-tests/tests/minimal/gloas/ssz_static/LightClientOptimisticUpdate/*/*",
}

tests_for_type! {
    LightClientUpdate<_>,
    "consensus-spec-tests/tests/mainnet/gloas/ssz_static/LightClientUpdate/*/*",
    "consensus-spec-tests/tests/minimal/gloas/ssz_static/LightClientUpdate/*/*",
}

tests_for_type! {
    MatrixEntry<_>,
    "consensus-spec-tests/tests/mainnet/gloas/ssz_static/MatrixEntry/*/*",
    "consensus-spec-tests/tests/minimal/gloas/ssz_static/MatrixEntry/*/*",
}
...
tests_for_type! {
    ...
    "consensus-spec-tests/tests/mainnet/gloas/ssz_static/PendingPartialWithdrawal/*/*",
    "consensus-spec-tests/tests/minimal/gloas/ssz_static/PendingPartialWithdrawal/*/*",
}

tests_for_type! {
    PowBlock,
    "consensus-spec-tests/tests/mainnet/gloas/ssz_static/PowBlock/*/*",
    "consensus-spec-tests/tests/minimal/gloas/ssz_static/PowBlock/*/*",
}
...
tests_for_type! {
    ...
    "consensus-spec-tests/tests/mainnet/gloas/ssz_static/SignedAggregateAndProof/*/*",
    "consensus-spec-tests/tests/minimal/gloas/ssz_static/SignedAggregateAndProof/*/*",
}

tests_for_type! {
    SignedBeaconBlock<_>,
    "consensus-spec-tests/tests/mainnet/gloas/ssz_static/SignedBeaconBlock/*/*",
    "consensus-spec-tests/tests/minimal/gloas/ssz_static/SignedBeaconBlock/*/*",
}

tests_for_type! {
    SignedBeaconBlockHeader,
    "consensus-spec-tests/tests/mainnet/gloas/ssz_static/SignedBeaconBlockHeader/*/*",
    "consensus-spec-tests/tests/minimal/gloas/ssz_static/SignedBeaconBlockHeader/*/*",
}

tests_for_type! {
    SignedBlsToExecutionChange,
    "consensus-spec-tests/tests/mainnet/gloas/ssz_static/SignedBLSToExecutionChange/*/*",
    "consensus-spec-tests/tests/minimal/gloas/ssz_static/SignedBLSToExecutionChange/*/*",
}
...
tests_for_type! {
    SignedVoluntaryExit,
    "consensus-spec-tests/tests/mainnet/gloas/ssz_static/SignedVoluntaryExit/*/*",
    "consensus-spec-tests/tests/minimal/gloas/ssz_static/SignedVoluntaryExit/*/*",
}

tests_for_type! {
    SigningData,
    "consensus-spec-tests/tests/mainnet/gloas/ssz_static/SigningData/*/*",
    "consensus-spec-tests/tests/minimal/gloas/ssz_static/SigningData/*/*",
}

tests_for_type! {
    SingleAttestation,
    "consensus-spec-tests/tests/mainnet/gloas/ssz_static/SingleAttestation/*/*",
    "consensus-spec-tests/tests/minimal/gloas/ssz_static/SingleAttestation/*/*",
}

tests_for_type! {
    SyncAggregate<_>,
    "consensus-spec-tests/tests/mainnet/gloas/ssz_static/SyncAggregate/*/*",
    "consensus-spec-tests/tests/minimal/gloas/ssz_static/SyncAggregate/*/*",
}

tests_for_type! {
    SyncAggregatorSelectionData,
    "consensus-spec-tests/tests/mainnet/gloas/ssz_static/SyncAggregatorSelectionData/*/*",
    "consensus-spec-tests/tests/minimal/gloas/ssz_static/SyncAggregatorSelectionData/*/*",
}

tests_for_type! {
    SyncCommittee<_>,
    "consensus-spec-tests/tests/mainnet/gloas/ssz_static/SyncCommittee/*/*",
    "consensus-spec-tests/tests/minimal/gloas/ssz_static/SyncCommittee/*/*",
}

tests_for_type! {
    SyncCommitteeContribution<_>,
    "consensus-spec-tests/tests/mainnet/gloas/ssz_static/SyncCommitteeContribution/*/*",
    "consensus-spec-tests/tests/minimal/gloas/ssz_static/SyncCommitteeContribution/*/*",
}

tests_for_type! {
    SyncCommitteeMessage,
    "consensus-spec-tests/tests/mainnet/gloas/ssz_static/SyncCommitteeMessage/*/*",
    "consensus-spec-tests/tests/minimal/gloas/ssz_static/SyncCommitteeMessage/*/*",
}

tests_for_type! {
    Validator,
    "consensus-spec-tests/tests/mainnet/gloas/ssz_static/Validator/*/*",
    "consensus-spec-tests/tests/minimal/gloas/ssz_static/Validator/*/*",
}

tests_for_type! {
    VoluntaryExit,
    "consensus-spec-tests/tests/mainnet/gloas/ssz_static/VoluntaryExit/*/*",
    "consensus-spec-tests/tests/minimal/gloas/ssz_static/VoluntaryExit/*/*",
}

tests_for_type! {
    Withdrawal,
    "consensus-spec-tests/tests/mainnet/gloas/ssz_static/Withdrawal/*/*",
    "consensus-spec-tests/tests/minimal/gloas/ssz_static/Withdrawal/*/*",
}

tests_for_type! {
    WithdrawalRequest,
    "consensus-spec-tests/tests/mainnet/gloas/ssz_static/WithdrawalRequest/*/*",
    "consensus-spec-tests/tests/minimal/gloas/ssz_static/WithdrawalRequest/*/*",
}
