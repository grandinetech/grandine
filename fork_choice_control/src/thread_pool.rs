    ...
    'outer: loop {
        ...
        loop {
            ...
            if let Some(task) = critical.high_priority_tasks.pop_front() {
                ...
                info!(
                    "thread {} starting task {task_name} (high priority)",
                    thread_name(),
                );
                ...
                info!(
                    "thread {} finished task {task_name} (high priority) in {} ms",
                    thread_name(),
            ...
            if let Some(task) = critical.low_priority_tasks.pop_front() {
                ...
                info!(
                    "thread {} starting task {task_name} (low priority)",
                    thread_name(),
                );
                ...
                info!(
                    "thread {} finished task {task_name} (low priority) in {} ms",
                    thread_name(),
                    started_at.elapsed().as_millis()
                );
