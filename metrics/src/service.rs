...
fn update_jemalloc_metrics(metrics: &Arc<Metrics>) -> Result<()> {
    ...
    metrics
        .set_jemalloc_bytes_allocated(tikv_jemalloc_ctl::stats::allocated::read().map_err(Error::msg)?);

    metrics.set_jemalloc_bytes_active(tikv_jemalloc_ctl::stats::active::read().map_err(Error::msg)?);
    metrics.set_jemalloc_bytes_metadata(tikv_jemalloc_ctl::stats::metadata::read().map_err(Error::msg)?);
    metrics.set_jemalloc_bytes_resident(tikv_jemalloc_ctl::stats::resident::read().map_err(Error::msg)?);
    metrics.set_jemalloc_bytes_mapped(tikv_jemalloc_ctl::stats::mapped::read().map_err(Error::msg)?);
    metrics.set_jemalloc_bytes_retained(tikv_jemalloc_ctl::stats::retained::read().map_err(Error::msg)?);
