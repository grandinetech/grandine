...
/// [`MAX_BUILDER_AUTH_DATA_SIZE`] from `builder-specs` (Gloas).
///
/// [`MAX_BUILDER_AUTH_DATA_SIZE`]: https://github.com/ethereum/builder-specs/blob/38f11441c194d150386f567b4d7087ec86d4118c/specs/gloas/builder.md#constants
