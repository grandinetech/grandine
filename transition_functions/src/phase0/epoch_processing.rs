...
mod spec_tests {
    ...
    #[test_resources(
        "consensus-spec-tests/tests/mainnet/phase0/epoch_processing/justification_and_finalization/*/*"
    )]
    ...
    #[test_resources(
        "consensus-spec-tests/tests/minimal/phase0/epoch_processing/justification_and_finalization/*/*"
    )]
    ...
    #[test_resources("consensus-spec-tests/tests/mainnet/phase0/epoch_processing/*/*/*")]
    fn mainnet_epoch_processing(case: Case) {
        run_epoch_case::<Mainnet>(case);
    }

    #[test_resources("consensus-spec-tests/tests/minimal/phase0/epoch_processing/*/*/*")]
    ...
    fn run_epoch_case<P: Preset>(case: Case) {
        ...
        let result = process_epoch(&P::default_config(), &mut state).map(|()| state);
