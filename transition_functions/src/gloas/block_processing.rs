...
use types::{
    ...
    gloas::{
        ...
        containers::{BeaconBlock, SignedBeaconBlock},
    },
    phase0::containers::SignedVoluntaryExit,
    preset::Preset,
};
...
pub fn custom_process_block<P: Preset>(
    ...
    // TODO(gloas): [spec](https://github.com/ethereum/consensus-specs/blob/master/specs/gloas/beacon-chain.md#block-processing)
...
mod spec_tests {
    ...
    // TODO(gloas): enable after `gloas::process_block` implemented in `block_processing.rs`
    // processing_tests! {
