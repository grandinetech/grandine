...
[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
unsafe internal delegate CResult<CPayloadStatusV1> EngineNewPayloadV3Delegate(CExecutionPayloadV3 payload, CVec<CH256> versionedHashes, CH256 parentBeaconBlockRoot);

[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
unsafe internal delegate CResult<CPayloadStatusV1> EngineNewPayloadV4Delegate(CExecutionPayloadV3 payload, CVec<CH256> versionedHashes, CH256 parentBeaconBlockRoot, CExecutionRequests executionRequests);
...
[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
unsafe internal delegate CResult<CExecutionPayloadV1> EngineGetPayloadV1Delegate(CH64 payloadId);

[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
unsafe internal delegate CResult<CEngineGetPayloadV2Response> EngineGetPayloadV2Delegate(CH64 payloadId);

[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
unsafe internal delegate CResult<CEngineGetPayloadV3Response> EngineGetPayloadV3Delegate(CH64 payloadId);

[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
unsafe internal delegate CResult<CEngineGetPayloadV4Response> EngineGetPayloadV4Delegate(CH64 payloadId);

[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
unsafe internal delegate CResult<CEngineGetPayloadV5Response> EngineGetPayloadV5Delegate(CH64 payloadId);

[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
unsafe internal delegate CResult<CVec<COption<CBlobAndProofV1>>> EngineGetBlobsV1Delegate(CVec<CH256> versionedHashes);

[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
unsafe internal delegate CResult<COption<CVec<CBlobAndProofV2>>> EngineGetBlobsV2Delegate(CVec<CH256> versionedHashes);
...
public class GrandineEngineApi
{
    ...
    */
        ...
        unsafe
        {
            ...
            */
            _adapter = new CEmbedAdapter
            {
                ...
                engine_new_payload_v3 = (delegate* unmanaged[Cdecl]<CExecutionPayloadV3, CVec<CH256>, CH256, CResult<CPayloadStatusV1>>)engine_newPayloadV3Ptr,
                engine_new_payload_v4 = (delegate* unmanaged[Cdecl]<CExecutionPayloadV3, CVec<CH256>, CH256, CExecutionRequests, CResult<CPayloadStatusV1>>)engine_newPayloadV4Ptr,
    ...
    unsafe CResult<CPayloadStatusV1> EngineNewPayloadV1(CExecutionPayloadV1 payload)
    {
        ...
        try
        {
            var payloadStatus = _engineRpc.engine_newPayloadV1(new Nethermind.Merge.Plugin.Data.ExecutionPayload
            {
                ...
                Transactions = GrandineUtils.ConvertTransactions(payload.transactions),
            }).Result;
            ...
            return CResult<CPayloadStatusV1>.Success(CPayloadStatusV1.From(payloadStatus.Data));
        }
        catch (Exception)
        {
            return CResult<CPayloadStatusV1>.Fail(1);
        };
    }
    ...
    unsafe CResult<CPayloadStatusV1> EngineNewPayloadV2(CExecutionPayloadV2 payload)
    {
        ...
        try
        {
            var payloadStatus = _engineRpc.engine_newPayloadV2(new Nethermind.Merge.Plugin.Data.ExecutionPayload
            {
                ...
                BlockHash = payload.block_hash.ToHash256(),
                Transactions = GrandineUtils.ConvertTransactions(payload.transactions),
                Withdrawals = GrandineUtils.ConvertWithdrawals(payload.withdrawals),
            }).Result;
    ...
    unsafe CResult<CPayloadStatusV1> EngineNewPayloadV3(CExecutionPayloadV3 payload, CVec<CH256> versionedHashes, CH256 parentBeaconBlockRoot)
    {
        ...
        try
        {
            ...
            }, GrandineUtils.ConvertVersionedHashes(versionedHashes), parentBeaconBlockRootConverted).Result;
    ...
    unsafe CResult<CPayloadStatusV1> EngineNewPayloadV4(CExecutionPayloadV3 payload, CVec<CH256> versionedHashes, CH256 parentBeaconBlockRoot, CExecutionRequests executionRequests)
    {
        ...
        try
        {
            ...
            }, GrandineUtils.ConvertVersionedHashes(versionedHashes), parentBeaconBlockRootConverted, executionRequestsConverted).Result;
    ...
    unsafe CResult<CForkChoiceUpdatedResponse> EngineForkchoiceUpdatedV1(CForkChoiceStateV1 state, COption<CPayloadAttributesV1> payload)
    {
        ...
        try {
            var forkchoiceUpdatedResult = _engineRpc.engine_forkchoiceUpdatedV1(
                ...
                GrandineUtils.ConvertPayloadAttributes(payload)
            ).Result;
            ...
            return CResult<CForkChoiceUpdatedResponse>.Success(CForkChoiceUpdatedResponse.From(forkchoiceUpdatedResult.Data));
        } catch (Exception e) {
            _logger.Error("Exception " + e);

            return CResult<CForkChoiceUpdatedResponse>.Fail(1);
        };
    }
    ...
    unsafe CResult<CExecutionPayloadV1> EngineGetPayloadV1(byte* payloadId)
    {
        ...
        try
        {
            var payload = _engineRpc.engine_getPayloadV1(payloadId.ToArray()).Result;
