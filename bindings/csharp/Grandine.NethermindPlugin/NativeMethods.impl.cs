...
public unsafe partial struct CExecutionPayloadV1
{
    public CExecutionPayloadV1(ExecutionPayload payload)
    {
        ...
        this.block_number = payload.BlockNumber;
        this.gas_limit = payload.GasLimit;
        this.gas_used = payload.GasUsed;
...
public unsafe partial struct CEngineGetPayloadV4Response
{
    ...
    {
        var requests = result.ExecutionRequests ?? throw new ArgumentException("GetPayloadV4Result.ExecutionRequests must not be null", nameof(result));
        this.execution_payload = new CExecutionPayloadV3(result.ExecutionPayload);
...
public unsafe partial struct CVec_u8
{
    public CVec_u8(nuint length)
    {
        ...
        unsafe
        {
            pointer = (IntPtr)NativeMethods.grandine_vec_alloc(NativeMethods.grandine_layout_u8(), length);
        }
...
public unsafe partial struct CVec_CVec_u8
{
    public CVec_CVec_u8(nuint length)
    {
        ...
        unsafe
        {
            pointer = (IntPtr)NativeMethods.grandine_vec_alloc(NativeMethods.grandine_layout_vec_u8(), length);
        }
...
public unsafe partial struct CVec_CBlobAndProofV2
{
    public CVec_CBlobAndProofV2(nuint length)
    {
        ...
        unsafe
        {
            pointer = (IntPtr)NativeMethods.grandine_vec_alloc(NativeMethods.grandine_layout_blob_and_proof_v2(), length);
        }
...
public unsafe partial struct CVec_COption_CBlobAndProofV1
{
    public CVec_COption_CBlobAndProofV1(nuint length)
    {
        ...
        unsafe
        {
            pointer = (IntPtr)NativeMethods.grandine_vec_alloc(NativeMethods.grandine_layout_option_blob_and_proof_v1(), length);
        }
...
public unsafe partial struct CVec_CTransaction
{
    public CVec_CTransaction(nuint length)
    {
        ...
        unsafe
        {
            pointer = (IntPtr)NativeMethods.grandine_vec_alloc(NativeMethods.grandine_layout_transaction(), length);
        }
...
public unsafe partial struct CVec_CWithdrawalV1
{
    public CVec_CWithdrawalV1(nuint length)
    {
        ...
        unsafe
        {
            pointer = (IntPtr)NativeMethods.grandine_vec_alloc(NativeMethods.grandine_layout_withdrawal(), length);
        }
...
public unsafe partial struct CVec_CH384
{
    public CVec_CH384(nuint length)
    {
        ...
        unsafe
        {
            pointer = (IntPtr)NativeMethods.grandine_vec_alloc(NativeMethods.grandine_layout_h384(), length);
        }
